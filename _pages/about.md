...
I am currently a PhD student in Computer Science at the University of Rochester, working at the intersection of human-computer interaction, human-AI interaction, AI literacy, educational technology, and interactive systems. My research focuses on designing, building, and evaluating AI-driven learning experiences, including embodied conversational agents, Minecraft-based AI literacy tools, educational games, and interactive prototypes.

I studied Computer Engineering at Sharif University of Technology to build the technical foundation for creating impactful software. Along the way, I also contributed to SSC, co-founded the educational NGO Rasta, taught programming and creative writing at NODET schools, published short stories, directed podcasts and radio plays, and designed the exhibition and curriculum for Iran's Computer Museum.
...
A Minecraft-based AI literacy tool for teaching filter bubbles, recommendation systems, and AI-driven personalization through embodied, game-based interaction. The project received the AAAI/ACM SIGAI Innovative AI Education Award and was published at EAAI 2026.

### BeeCurious / Meet Bip

A Minecraft-based testbed for studying embodied peer agents in exploratory learning environments. The project investigates how a peer-like bee agent can support learners through spatially grounded dialogue, bounded knowledge, and AI literacy scaffolding.
...
2022, Developer. An easy-to-use Godot add-on for creating tutorials and introduction sections inside Godot scenes.
...
2022, Designer and Developer. A drag-and-drop 2D game developed with Godot to help elementary students improve their literacy skills through gameplay. Students play as an environmental journalist who writes reports on city events, helps out in the office, and protects a pot of flowers.
...
2021, Developer. A simple multiplayer online game, developed with Django Channels and Godot, in which players compete to collect three cards that add up to 15 while preventing their opponent from doing so first.
...
2020--2022, CTO. My thesis project, later developed into a gamified platform that helps institutes and teachers hold online workshops and provide semi-personalized content to students. The platform was built with Django, Docker, and React.
...
2020, Designer. In the early days of Covid-19, we designed an online gamified contest to promote connectivity and interaction during the transition to e-learning. Students played as pirates, explored islands, solved quizzes and mysteries, traded, and competed with other players.
...
2016--2019, Director. A 75-minute documentary based on my memories from school years and Iran's educational system.
